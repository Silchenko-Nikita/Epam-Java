...
public class ContemporaryDisneyPlot implements Plot {
    ...
    public String toString() {
        return String.format("%s feels a bit awkward and uncomfortable. " +
                ...
                "But putting self together and help of friends, including spectacular " +
                "funny %s restore the spirit and %s overcomes " +
                "the crisis and gains gratitude and respect", hero.name(), epicCrisis.name(), hero.name(), funnyFriend.name(), hero.name());
    }
}
